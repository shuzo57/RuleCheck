...
const CorrectionTypeBadge: React.FC<{ type: '必須' | '任意' }> = ({ type }) => {
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-slate-200">
          <thead className="bg-slate-50">
            <tr>
              <th scope="col" className="px-3 py-3 text-left text-xs font-semibold text-slate-600 uppercase tracking-wider w-24">スライド番号</th>
              <th scope="col" className="px-3 py-3 text-left text-xs font-semibold text-slate-600 uppercase tracking-wider w-36">カテゴリ</th>
              {isBasisAugmented && (
                <th scope="col" className="px-3 py-3 text-left text-xs font-semibold text-slate-600 uppercase tracking-wider min-w-[200px]">根拠</th>
              )}
              <th scope="col" className="px-3 py-3 text-left text-xs font-semibold text-slate-600 uppercase tracking-wider min-w-[200px]">指摘事項</th>
              <th scope="col" className="px-3 py-3 text-left text-xs font-semibold text-slate-600 uppercase tracking-wider min-w-[200px]">改善案</th>
              <th scope="col" className="px-3 py-3 text-left text-xs font-semibold text-slate-600 uppercase tracking-wider w-32">修正の種類</th>
              <th scope="col" className="px-1 py-3 w-16"><span className="sr-only">アクション</span></th>
            </tr>
          </thead>

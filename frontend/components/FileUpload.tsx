    ...
    <div className="bg-white p-6 sm:p-8 rounded-lg shadow-lg space-y-6">
        ...
        <div className="flex justify-end space-x-3 pt-4">
            ...
            <button
                ...
                className="px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 disabled:bg-blue-300 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
            >
                {stagedFiles.length}件のファイルをアップロード
            </button>
        </div>
    </div>
  );
